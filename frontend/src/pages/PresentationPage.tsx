...
def semantic_similarity(text1, text2):
  ...
  },
  {
    ...
    description: "Full-stack AI platform: entity extraction, DNA, bias detection, auto-reports.",
...
const TECH_STACK = [
  ...
  { name: "Transformers", category: "AI", color: "#ff9800" },
  { name: "SQLAlchemy", category: "Database", color: "#d35400" },
  { name: "ReportLab", category: "Reports", color: "#e91e63" },
...
export function PresentationPage() {
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <p className="text-slate-400 mb-8">7 stages from file I/O to enterprise AI platform</p>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 glass-card p-5">
                  ...
                  <pre className="bg-black/40 rounded-xl p-4 text-xs font-mono text-emerald-300 overflow-x-auto">
                    {stage.code}
                  </pre>
                </div>
              </motion.div>
      ...
      <div className="mt-16 mb-12">
        ...
        <p className="text-slate-400 mb-6">Production-grade technologies used in this platform</p>
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            "Smart Document Ingestion", "Document Overview Dashboard", "Advanced Word Analysis",
            "AI Topic Detection", "Sentiment Analysis", "Emotion Analysis",
            "Document DNA Engine", "AI Summary Generator", "Writing Style Analyzer",
            "Document Comparison", "AI Insight Generator", "AI Bias Detector",
            "Question Generator", "Quiz Generator", "Entity Extraction",
            "Trend Analysis", "Report Generation", "Premium Dashboard UI",
            ...
            >
              <span className="text-brand-400 text-xs font-bold">M{i + 1}</span>
      ...
      <div className="glass-card p-8 bg-gradient-to-br from-brand-500/10 to-purple-500/10 border border-brand-500/20">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            { icon: "🎓", title: "Academic Research", desc: "Paper analysis, citation studies, plagiarism detection" },
            { icon: "📰", title: "Media Analysis", desc: "News bias detection, sentiment tracking, topic modeling" },
            { icon: "💼", title: "Enterprise Intelligence", desc: "Document processing, contract analysis, report generation" },
            { icon: "⚖️", title: "Legal Tech", desc: "Contract review, clause extraction, compliance checking" },
            { icon: "🏥", title: "Healthcare", desc: "Clinical note analysis, patient feedback, medical literature" },
            { icon: "📊", title: "Market Research", desc: "Brand sentiment, consumer feedback, trend analysis" },
